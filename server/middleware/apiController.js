...
apiController.save = async (req, res, next) => {
    try {
        if (req.body.snipID) {
            ...
            const string = 'UPDATE codesnippets SET title = $1, code = $2, dateEdited = NOW() WHERE snipID = $3;'
            ...
            const string = 'INSERT INTO codesnippets (userID, title, code) VALUES ($1, $2, $3) RETURNING snipID;';
